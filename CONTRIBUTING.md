...
Any public project written in or for Mach, first-party or not. This is the complete catalog, not a curated list, so small and early projects are welcome. Private and archived repositories are not listed, and CI rejects them.
